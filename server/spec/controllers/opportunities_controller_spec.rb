  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved opportunity as @opportunity" do
        ...
        allow_any_instance_of(Opportunity).to receive(:save).and_return(false)
        post :create, {:opportunity => { "title" => "invalid value" }}, valid_session
        expect(assigns(:opportunity)).to be_a_new(Opportunity)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested opportunity" do
        ...
        expect_any_instance_of(Opportunity).to receive(:update).with({ "title" => "MyString" })
        put :update, {:id => opportunity.to_param, :opportunity => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the opportunity as @opportunity" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Opportunity).to receive(:save).and_return(false)
        put :update, {:id => opportunity.to_param, :opportunity => { "title" => "invalid value" }}, valid_session
        expect(assigns(:opportunity)).to eq(opportunity)
      end
